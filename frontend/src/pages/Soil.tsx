...
export default function Soil() {
    const [formData, setFormData] = useState({ nitrogen: 50, phosphorus: 30, potassium: 40, ph: 6.5, moisture: 35 });
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-gray-900">Soil Health Advisory</h1>
                <p className="text-gray-600 mt-2">Enter soil parameters to get an AI-powered assessment.</p>
            </div>

            <form onSubmit={handleSubmit} className="bg-white p-6 shadow rounded-lg border border-gray-200 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                    <div className="bg-white p-6 shadow rounded-lg border border-gray-200">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div><span className="text-gray-500">Predicted Category:</span> <span className="font-semibold text-gray-900">{result.predicted_category}</span></div>
